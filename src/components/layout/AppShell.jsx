...
export default function AppShell() {
  ...
  const { loading: authLoading } = useAuth(); // ← this should now work
  ...
  return (
    <div className="flex flex-col min-h-screen max-w-md mx-auto bg-white relative">
      ...
      <LoadingOverlay
        ...
        message="Preparing your pet world..."
      />

      {/* Main content – dimmed during global loading */}
      <div className={authLoading ? "opacity-60 pointer-events-none" : ""}>
