...
export const updatePet = (id, data) => API.patch(`/pets/${id}/`, data);

export const deletePet = (id) => API.delete(`/pets/${id}/`);

export const getPetQR = (id) => API.get(`/pets/${id}/qr/`);

export const getHealthCard = (id) => API.get(`/pets/${id}/health_card/`);

export const getVaccinations = (id) => API.get(`/pets/${id}/vaccinations/`);
