...
export default function PetDetail() {
  ...
  if (!pet)
    return <div className="p-6 text-center text-gray-500">Pet not found</div>;
  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <div className="bg-sage-dark px-5 pt-10 pb-8">
        <button
          onClick={() => navigate(-1)}
          className="text-white/70 mb-4 flex items-center gap-1"
        >
          ...
          <div className="space-y-3">
            ...
            {vaccinations.map((v, i) => (
              ...
              >
                ...
                {v.vet_clinic && (
                  <p className="text-xs text-sage-dark mt-1">{v.vet_clinic}</p>
                )}
              </div>
            ))}
            <button
