    ...
    <div className="min-h-screen bg-cream">
      <div className="bg-sage-dark px-5 pt-12 pb-6">
        ...
        <p className="text-sage-light text-sm mt-1">
          Share and connect with pet parents
        </p>
      </div>
      ...
      <div className="px-5 py-4 space-y-4 pb-24">
          ...
          >
            ...
            <div className="px-4 py-3 flex items-center gap-5 border-t border-gray-50">
              ...
              >
                ...
                />
                <span
                  className={post.is_liked ? "text-red-500" : "text-gray-400"}
                >
                  {post.likes_count || 0}
                </span>
              </button>
        ...
        <button
          ...
          className="w-full mt-2 py-4 border-2 border-dashed border-sage-dark/40 rounded-2xl text-sage-dark font-bold flex items-center justify-center gap-2 active:scale-[0.98] transition-transform"
        >
