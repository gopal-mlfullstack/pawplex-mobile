    ...
    <div className="min-h-screen bg-cream">
        ...
        {loading ? (
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-400 mt-0.5">
                        {l.breed || l.species} · {l.gender} · {l.age || ""}
                      </p>
                      {l.description && (
          ...
          <>
            ...
            {lostFound.map((item) => (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className={`text-[10px] font-bold px-2 py-1 rounded-full ${item.type === "lost" ? "bg-red-100 text-red-700" : "bg-green-100 text-green-700"}`}
                  >
                    {item.type}
                  </span>
                </div>
            ...
            <button
              ...
              className="w-full mt-4 py-4 border-2 border-dashed border-red-300 rounded-2xl text-red-500 text-sm font-bold flex items-center justify-center gap-2 active:scale-[0.98] transition-transform"
            >
      ...
      {selectedListing && (
        <div className="fixed inset-0 bg-black/40 z-50 flex items-end">
          <div className="bg-white w-full rounded-t-3xl p-6 pb-24 max-h-[85vh] overflow-y-auto animate-slide-up">
            ...
            <p className="text-sm text-gray-600 mb-3">
              Interested in{" "}
              <strong>
                {selectedListing.pet_name || selectedListing.name}
              </strong>
              ?
            </p>
            <textarea
              ...
              placeholder="Tell the shelter why you'd be a great pet parent…"
              rows={3}
